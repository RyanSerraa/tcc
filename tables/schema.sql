...
ALTER TABLE DLocalidade RENAME COLUMN avgBlack TO mediaNegros;
ALTER TABLE DLocalidade RENAME COLUMN avgWhite TO mediaBrancos;
ALTER TABLE DLocalidade RENAME COLUMN avgHispanic TO mediaHispanicos;
ALTER TABLE DLocalidade RENAME COLUMN avgAsian TO mediaAsiaticos;
ALTER TABLE DLocalidade RENAME COLUMN standardDeviationBlack TO desvioPadraoNegros;
ALTER TABLE DLocalidade RENAME COLUMN standardDeviationWhite TO desvioPadraoBrancos;
ALTER TABLE DLocalidade RENAME COLUMN standardDeviationHispanic TO desvioPadraoHispanicos;
ALTER TABLE DLocalidade RENAME COLUMN standardDeviationAsian TO desvioPadraoAsiaticos;

-- Renomeando colunas de DPessoa
ALTER TABLE DPessoa RENAME COLUMN idGroupAge TO idFaixaEtaria;
ALTER TABLE DPessoa RENAME COLUMN name TO nome;
ALTER TABLE DPessoa RENAME COLUMN gender TO genero;
ALTER TABLE DPessoa RENAME COLUMN race TO raca;
ALTER TABLE DPessoa RENAME COLUMN typePerson TO tipoPessoa;
ALTER TABLE DPessoa RENAME COLUMN rangeInf TO faixaInf;
ALTER TABLE DPessoa RENAME COLUMN rangeSup TO faixaSup;

-- Renomeando colunas de DCausaMorte
ALTER TABLE DCausaMorte RENAME COLUMN "desc" TO descricao;
